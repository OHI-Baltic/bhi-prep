...
#### 1.4.1 PCB Concentration Indicator Biota
...
#### 1.4.2 TEQ values for Dioxins and Dioxin-like PCBs in Biota
...
#### 1.4.4 TEQ values for PCBs in Sediment
...
#### 1.4.5 TEQ values for Dioxins in Sediments
