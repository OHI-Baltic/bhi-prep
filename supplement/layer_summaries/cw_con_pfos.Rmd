...
[cw_con_pfos](https://github.com/OHI-Baltic/bhi-prep/blob/master/layers/cw_con_pfos_bhi2019.csv)\
*Units: ug_per_kg*\
*Category:*\
*Subcategory:*\
...
PFOS total concentration by date and location, derived from measurements obtained from ICES database.\
