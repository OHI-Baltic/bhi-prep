---
title: "Inverse Secchi Depth Pressure Layer Data Preparation"
output:
  github_document:
    toc: true
    toc_depth: 3
...
```{r inverse secchi depth preamble, echo = FALSE, include = FALSE, error = FALSE}
knitr::opts_chunk$set(message = FALSE, warning = FALSE, echo = TRUE, results = "show", fig.width = 9.5, fig.height = 6)
source(here::here("R", "setup.R"))
source(here::here("R", "spatial.R"))

dir <- here::here("prep", "PRSS", "inverse_secchi_depth", "v2021")
...
These are saved to the `layers` folder. Saved to `prep/PRSS/inverse_secchi_depth/v2021/intermediate` are intermediate datasets: `DATASETINTEMED1.csv` and `DATASETINTEMED2.csv`. All these are derived from or informed by the raw datasets from RAW DATA SOURCES.
...
<!-- dataset save location BHI_share/BHI 3.0/Pressures/ -->
...
```{r invasive spp raw data, echo = TRUE, message = FALSE, warning = FALSE, results = "hide"}
## root location of the raw data
dir_rawdata <- file.path(dir_B, "Pressures", "inverse_secchi_depth")
```
