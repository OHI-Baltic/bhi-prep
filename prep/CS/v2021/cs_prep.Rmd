...
macrophytes <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Zostera_marina_LC",
...
chara_con_lc <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Chara_connivens_LC",
  "Join_macrophytes.shp"
)) # CRS: 3035

chara_tom_lc <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Chara_tomentosa_LC",
  "Join_macrophytes.shp"
)) # CRS: 3035

chara_hor_nt <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Chara_horrida_NT",
  "Join_macrophytes.shp"
)) # CRS: 3035

crassula_nt <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Crassula_aquatica_NT",
  "Join_macrophytes.shp"
)) # CRS: 3035

furcellaria_lc <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Furcellaria_lumbricalis_LC",
  "Join_macrophytes.shp"
)) # CRS: 3035

persicaria_en <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Persicaria_foliosa_EN",
  "Join_macrophytes.shp"
)) # CRS: 3035

potamogeton_nt <- sf::st_read(file.path(
  dir_rawdata, "HELCOM_species", "Potamogeton_friesii_NT",
  "Join_macrophytes.shp"
)) # CRS: 3035
