---
title: "Contaminants (CON) - Clean Waters Subgoal (CW) Data Prep"
output:
  github_document:
    toc: true
    toc_depth: 3
...
These are saved to the `layers` folder. Saved to `prep/CON/v2021/intermediate` are intermediate datasets: `DATASETINTEMED1.csv` and `DATASETINTEMED2.csv`. All these are derived from or informed by the raw datasets from RAW DATA SOURCES.
...
```{r con load raw data, echo = TRUE, message = FALSE, warning = FALSE, results = "hide"}
